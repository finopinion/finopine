...
sources:
  - label: "Better targeted superannuation concessions — new legislation guidance"
    ...
    supports: "That the measure is law and reduces concessions on earnings for balances above the large super balance threshold from 1 July 2026."
    retrievedAt: "2026-08-27"
    verified: true
  - label: "Better Targeted Super Concessions is now law"
    publisher: "Australian Taxation Office"
    url: "https://www.ato.gov.au/tax-and-super-professionals/for-superannuation-professionals/super-funds-newsroom/better-targeted-super-concessions-is-now-law"
    supports: "Royal assent on 13 March 2026, the $3m and $10m thresholds, indexation in $150,000 and $500,000 increments, and the greater-of test for later years."
    retrievedAt: "2026-08-27"
    date: "2026-03"
    verified: true
  - label: "Division 296: revised $3m+ super tax"
    publisher: "SMSF Adviser"
    url: "https://www.smsfadviser.com/division-296-revised-3m-super-tax/"
    supports: "The transitional arrangements and how total superannuation earnings are attributed above each threshold."
    retrievedAt: "2026-08-27"
    date: "2026-02"
    verified: true
  - label: "On the Division 296 super tax — the case for the policy"
    publisher: "Superannuation (Substack)"
    url: "https://superannuation.substack.com/p/on-super-div-296-tax"
    supports: "The policy case for Division 296 and the argument that campaigns against it misrepresent its effect. Used for the counter-case section."
    retrievedAt: "2026-08-27"
    verified: true
---
...
The arithmetic is not subtle. $150,000 against a three million dollar threshold is five per cent. At inflation inside the target band, cumulative price growth takes roughly two years to reach five per cent — and the threshold does nothing at all until it gets there. In the intervening period the nominal line is fixed while balances compound.
...
Two things, both observable. How often the large balance threshold actually steps between now and 2030, and what happens to the count of members assessed under Division 296 across those years. If the threshold moves at least every second year and the assessed population stays roughly flat as a share of members, the increment size never mattered. If the threshold sits still for three years while the assessed count climbs, the word "indexed" was doing work the mechanism could not support.
