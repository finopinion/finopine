---
jurisdiction: "au"
title: "The Bank changed which inflation number counts, then kept watching the old one"
dek: "Australia now measures its inflation target against a monthly figure. The Reserve Bank says it will keep making rate decisions off a quarterly one until 2027. Those are two different numbers."
...
sources:
  - label: "Statement by the Monetary Policy Board: Monetary Policy Decision, 11 August 2026"
    ...
    supports: "The 11 August decision to hold at 4.35 per cent, the reference to three increases since the start of the year, and the statement that inflation is not expected to return to around the midpoint until late 2027."
    retrievedAt: "2026-08-27"
    date: "2026-08-11"
    verified: true
  - label: "Box C: The Transition to a Complete Monthly CPI, Statement on Monetary Policy, November 2025"
    publisher: "Reserve Bank of Australia"
    url: "https://www.rba.gov.au/publications/smp/2025/nov/box-c-the-transition-to-a-complete-monthly-cpi.html"
    supports: "That headline inflation from the complete monthly CPI becomes the target for monetary policy, and that the monthly CPI Indicator has been discontinued."
    retrievedAt: "2026-08-27"
    date: "2025-11"
    verified: true
  - label: "Technical Note: The Transition to a Complete Monthly CPI"
    ...
    date: "2025-11"
    verified: true
  - label: "Frequently asked questions about the Consumer Price Index"
    publisher: "Australian Bureau of Statistics"
    url: "https://www.abs.gov.au/articles/frequently-asked-questions-faqs-about-consumer-price-index"
    supports: "That the final Monthly CPI Indicator was released in October 2025 and that the Indicator was an incomplete measure of Australian inflation."
    retrievedAt: "2026-08-27"
    verified: true
  - label: "Consumer Price Index, Australia — latest release"
    publisher: "Australian Bureau of Statistics"
    url: "https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation/consumer-price-index-australia/latest-release"
    supports: "The current CPI release, confirming the complete Monthly CPI is now the published headline series."
    retrievedAt: "2026-08-27"
    verified: true
---
